...
const Header = () => {
    return (
        ...
        <div className='porfolio-info--header section'>
            <img src={logo} alt="My personal photo" />
            <h1 className={`title mt-1 text-2xl font-bold`}>Michael Nakashima | Naka</h1>
            <h2 className='subtitle -mt-2 font-semibold text-lg mb-3'>Front-end Enginner</h2>

            <p className={`text mb-3 text-sm font-light `}>
